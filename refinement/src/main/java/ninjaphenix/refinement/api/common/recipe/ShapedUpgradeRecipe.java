...
public class ShapedUpgradeRecipe implements ITierRecipe
{
    ...
    {
        @Override
        public ShapedUpgradeRecipe read(final ResourceLocation recipeId, final JsonObject json)
        {
            return null;
        }
        ...
        @Nullable
        @Override
        public ShapedUpgradeRecipe read(final ResourceLocation recipeId, final PacketBuffer buffer)
        {
            return null;
        }

        @Override
        public void write(final PacketBuffer buffer, final ShapedUpgradeRecipe recipe)
        {
