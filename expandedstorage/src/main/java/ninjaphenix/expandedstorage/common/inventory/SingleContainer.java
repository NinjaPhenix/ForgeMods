...
{
    private static final ImmutableSortedMap<Integer, SingleScreenMeta> SIZES = new ImmutableSortedMap.Builder<Integer, SingleScreenMeta>(Integer::compare).put(27, new SingleScreenMeta(9, 3, 27, getTexture("shared", 9, 3), 208, 192)) // Wood
    ...
    public SingleContainer(final int windowId, final BlockPos pos, final IInventory inventory, final PlayerEntity player, final @Nullable ITextComponent displayName)
    {
    ...
    {
        @Override
        public @Nullable SingleContainer create(final int windowId, final PlayerInventory playerInventory, final @Nullable PacketBuffer data)
        {
            if (data == null)
            {
                return null;
