...
//
//public abstract class OLD_AbstractContainer<T extends ScreenMeta> extends Container
//{
...
//
//    public OLD_AbstractContainer(final ContainerType<?> type, final int windowId, final BlockPos pos, final IInventory inventory,
