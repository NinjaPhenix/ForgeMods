...
public final class ScrollableScreenMeta extends ScreenMeta
{
    ...
    public ScrollableScreenMeta(final int width, final int height, final int totalSlots, final ResourceLocation texture, final int textureWidth, final int textureHeight)
    {
