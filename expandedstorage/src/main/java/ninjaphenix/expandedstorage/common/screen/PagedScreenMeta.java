...
public final class PagedScreenMeta extends ScreenMeta
{
    ...
    public PagedScreenMeta(final int width, final int height, final int pages, final int totalSlots, final ResourceLocation texture, final int textureWidth, final int textureHeight)
    {
