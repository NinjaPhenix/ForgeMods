...
//
//public abstract class OLD_ChestModifierItem extends Item
//{
//    private static final DirectionProperty FACING = OLD_BaseChestBlock.FACING;
//    private static final EnumProperty<CursedChestType> TYPE = OLD_BaseChestBlock.TYPE;
//
//    public OLD_ChestModifierItem() { super(); }
//
//    @Override
...
//        if (state.getBlock() instanceof OLD_BaseChestBlock)
//        {
