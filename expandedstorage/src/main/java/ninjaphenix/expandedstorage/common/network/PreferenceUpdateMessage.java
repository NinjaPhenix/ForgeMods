...
public final class PreferenceUpdateMessage
{
    ...
    public PreferenceUpdateMessage(final ResourceLocation preference)
    {
    ...
    static PreferenceUpdateMessage decode(final PacketBuffer buffer)
    {
        return new PreferenceUpdateMessage(buffer.readResourceLocation());
    }
