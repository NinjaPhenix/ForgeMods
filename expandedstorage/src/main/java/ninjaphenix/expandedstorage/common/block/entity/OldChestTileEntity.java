...
public final class OldChestTileEntity extends BaseChestTileEntity
{
    ...
    public OldChestTileEntity(final @Nullable ResourceLocation block)
    {
        super(ModContent.OLD_CHEST_TE, block);
    }
    ...
    {
        this.block = block;
        final Registries.TierData data = Registries.OLD.getValue(block).get();
