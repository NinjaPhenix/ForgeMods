...
public final class CursedChestBlock extends BaseChestBlock<CursedChestTileEntity> implements IWaterLoggable
{
    ...
    private static final VoxelShape[] HORIZONTAL_VALUES = {Block.makeCuboidShape(1, 0, 0, 15, 14, 15), Block.makeCuboidShape(1, 0, 1, 16, 14, 15), Block.makeCuboidShape(1, 0, 1, 15, 14, 16), Block.makeCuboidShape(0, 0, 1, 15, 14, 15)};
