...
//
//public final class OLD_ScrollableScreen extends OLD_AbstractScreen<OLD_ScrollableContainer, ScrollableScreenMeta>
//{
...
//
//    public OLD_ScrollableScreen(final OLD_ScrollableContainer container, final PlayerInventory playerInventory, final ITextComponent title)
//    {
...
//    {
//        super.init();
//        final int settingsXOffset = -(hasScrollbar ? (OLD_ExpandedStorageConfig.CLIENT.centerSettingsButtonOnScrollbar.get() ? 2 : 1) :
...
//    {
//        setTopRow(topRow,
//                MathHelper.floor(MathHelper.clampedLerp(0, SCREEN_META.TOTAL_ROWS - SCREEN_META.HEIGHT, (mouseY - guiTop + 18) / (SCREEN_META.HEIGHT * 18))));
//    }
//
//    @Override
//    public boolean mouseScrolled(final double mouseX, final double mouseY, final double delta)
//    {
//        if (hasScrollbar && (!OLD_ExpandedStorageConfig.CLIENT.restrictiveScrolling.get() || isMouseOverScrollbar(mouseX, mouseY)))
//        {
//            final int newTop;
