...
//
//public final class OLD_SelectContainerScreen extends Screen
//{
...
//    private int TOP;
//
//    public OLD_SelectContainerScreen() { super(new TranslationTextComponent("screen.expandedstorage.screen_picker_title")); }
//
//    @Override
//    protected void init()
//    {
...
//    public void onClose()
//    {
//        OLD_Networker.INSTANCE.sendRemovePreferenceCallbackToServer();
//        super.onClose();
//    }
//
//    private void updatePlayerPreference(final ResourceLocation selection)
//    {
//        OLD_ExpandedStorageConfig.CLIENT.preferredContainerType.set(selection.toString());
//        OLD_Networker.INSTANCE.sendPreferenceToServer();
//        super.onClose();
//    }
//
//    @Override
