...
public abstract class OLD_AbstractScreen<T extends OLD_AbstractContainer<R>, R extends ScreenMeta> extends GuiContainer
{
    protected final R SCREEN_META;
    private final Integer INVENTORY_LABEL_LEFT;

    protected OLD_AbstractScreen(final T container, final PlayerInventory playerInventory, final ITextComponent title,
