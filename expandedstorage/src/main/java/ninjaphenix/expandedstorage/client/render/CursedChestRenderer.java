...
public class CursedChestRenderer extends TileEntityRenderer<CursedChestTileEntity>
{
    ...
    @Override
    public void render(@NotNull final CursedChestTileEntity te, final float v,
            @NotNull final MatrixStack stack, @NotNull final IRenderTypeBuffer buffer, final int light, final int overlay)
    {
